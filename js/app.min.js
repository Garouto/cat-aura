(() => {
    ...
    let o = !0,
        ...
        s = (t = 500) => {
            if (o) {
                ...
                })), document.body.style.paddingRight = a, document.documentElement.classList.add("lock"), o = !1, setTimeout((function() {
                    o = !0
                }), t)
            }
        };
    ...
    let i = (t, e = !1, o = 500, a = 0) => {
            ...
            if (s) {
                ...
                if (e) {
                    ...
                    t.classList.contains("_header-scroll") ? i = t.offsetHeight : (t.style.cssText = "transition-duration: 0s;", t.classList.add("_header-scroll"), i = t.offsetHeight, t.classList.remove("_header-scroll"), setTimeout((() => {
                        t.style.cssText = ""
                    }), 0))
                }
                let l = {
                ...
                if (document.documentElement.classList.contains("menu-open") && n(), "undefined" != typeof SmoothScroll)(new SmoothScroll).animateScroll(s, "", l);
                else {
                    let t = s.getBoundingClientRect().top + scrollY;
                    t = i ? t - i : t, t = a ? t - a : t, window.scrollTo({
                        top: t,
                        behavior: "smooth"
                    })
                }
    ...
    new class {
        ...
        init() {
            this.оbjects = [], this.daClassname = "_dynamic_adapt_", this.nodes = [...document.querySelectorAll("[data-da]")], this.nodes.forEach((t => {
                const e = t.dataset.da.trim().split(","),
                    o = {};
                o.element = t, o.parent = t.parentNode, o.destination = document.querySelector(`${e[0].trim()}`), o.breakpoint = e[1] ? e[1].trim() : "767.98", o.place = e[2] ? e[2].trim() : "last", o.index = this.indexInParent(o.parent, o.element), this.оbjects.push(o)
            })), this.arraySort(this.оbjects), this.mediaQueries = this.оbjects.map((({
                breakpoint: t
            }) => `(${this.type}-width: ${t/16}em),${t}`)).filter(((t, e, o) => o.indexOf(t) === e)), this.mediaQueries.forEach((t => {
                const e = t.split(","),
                    o = window.matchMedia(e[0]),
                    a = e[1],
                    s = this.оbjects.filter((({
                        breakpoint: t
                    }) => t === a));
        ...
        moveTo(t, e, o) {
            e.classList.add(this.daClassname), "last" === t || t >= o.children.length ? o.append(e) : "first" !== t ? o.children[t].before(e) : o.prepend(e)
        }
        moveBack(t, e, o) {
    ...
    d && (window.onscroll = () => {
        window.scrollY <= d.offsetHeight && function() {
            const t = window.scrollY,
                e = d.offsetHeight;
            let o = t / e;
            o > 100 && (o = 100), h.style.transform = `translateY(${o*e/2.8}px)`, u.style.transform = `translateY(${o*e/4}px)`
        }()
    ...
    function p() {
        f = window.innerWidth < 1450 ? 15 : (window.innerWidth - 1420) / 2, m.length && m.forEach((t => {
            t.style.paddingLeft = f + "px"
        })), g.length && g.forEach((t => {
            t.style.paddingRight = f + "px"
        }))
    }
    p(), document.body.onresize = p, window.FLS = !1, document.documentElement.classList.contains("loading") || window.addEventListener("load", (function() {
            setTimeout((function() {
        ...
        function() {
                ...
                if ("click" === e.type) {
                    ...
                    if (o.closest("[data-goto]")) {
                        ...
                        if (t.fullpage) {
                            ...
                            null !== o && (t.fullpage.switchingSection(o), document.documentElement.classList.contains("menu-open") && n())
                        } else i(s, c, r, l);
                        e.preventDefault()
                    }
            ...
            if (document.addEventListener("click", o), document.addEventListener("watcherCallback", o), e()) {
                let t;
                document.querySelector(`#${e()}`) ? t = `#${e()}` : document.querySelector(`.${e()}`) && (t = `.${e()}`), t && i(t, !0, 500, 20)
            }
        }()
})();